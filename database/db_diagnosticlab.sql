...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2023 at 10:17 AM
...
(48, 'APT00048', 7, '2023-12-01 14:40:00', '', 0, 1, '2023-11-03 10:11:04', NULL),
...
(51, 'APT00051', 10, '2023-11-25 09:59:00', '', 2500, 0, '2023-11-06 05:29:42', NULL),
...
--
ALTER TABLE `tb_appointment`
  MODIFY `apt_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tb_appointment_list`
--
ALTER TABLE `tb_appointment_list`
  MODIFY `apt_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
